...
const generateAuthTokens = async (user) => {
  ...
  //console.log('inside token service', user)

  // const jwtToken = generateToken(user._id, 60*60*24*5,tokenTypes.ACCESS)

  // const expiryDate = new Date(Date.now()+60*60*24*5);
  // const res = {access: {token: jwtToken, expires: expiryDate }};
